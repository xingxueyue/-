                    ...
                    <div class="wrapper wrapper-content animated fadeInRight">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <form action ="<%=base %>admin/Category" method ="post">
                                          ...
                                          <div class="col-md-3"><button title="Create new cluster" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <span class="bold">增加分类</span></button></div>
                       ...
                       %>
                        <div class="faq-item">
                            <div class="row">
                                <div class="col-md-8">
                                    <a data-toggle="collapse" href="" class="faq-question"><%=category.getTitle() %></a>
                                    <small> <i class="fa fa-clock-o"></i> <%=category.getCreatedAt() %></small>
                                </div>
                                <div class="col-md-2">
                           
                                <a href="<%=base%>admin/CategoryEdit?action=edit&id=<%=category.getId()%>"><button type="button" class="btn btn-w-m btn-info">编辑</button> </a>
                                </div>
                                <div class="col-md-2">
