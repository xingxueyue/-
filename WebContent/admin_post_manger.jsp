...
<%@ page import= "java.util.*,tzc.blog.bean.Post"  %>
                ...
                <div class="col-lg-12">
                    <div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <div class="ibox-content m-b-sm border-bottom">
                            <div class="text-center p-lg">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <form action ="<%=base %>admin/PostManger" method ="post">
                                                <div class="col-md-4"><input name="title" type="text" placeholder="文章名称" class="form-control"></div>

                                                <div class="col-md-3"><button title="Create new cluster" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <span class="bold">搜索</span></button></div>
                        ...
                        <div class="faq-item">
                            <div class="row">
                                <div class="col-md-8">
                                    <a href="<%=base%>admin/Reply?id=<%=post.getId()%>" class="faq-question"><%=post.getTitle() %></a>
                                    <span>观看次数：<%=post.getView_count() %></span>&emsp;
                                    <small> <i class="fa fa-clock-o"></i> <%=post.getCreate_at() %></small>
                                </div>
                                <div class="col-md-2">

                                    <a href="<%=base%>admin/PostEdit?action=edit&id=<%=post.getId()%>"><button type="button" class="btn btn-w-m btn-info">编辑</button> </a>
                                </div>
                                <div class="col-md-2">
                                    <form action="<%=base %>admin/PostEdit" method="post">
                                        <input name="id" value="<%=post.getId()%>" type="hidden"/>
                                        <input name="action" value="delete" type="hidden"/>
                                        <button type="submit" class="btn btn-w-m btn-warning">刪除</button>
                                    </form>
